...
imm_coeff = parser.add_mutually_exclusive_group(required=True)
imm_coeff.add_argument('--lambda_ratio', type=float)
imm_coeff.add_argument('--lambda_param', type=float)
